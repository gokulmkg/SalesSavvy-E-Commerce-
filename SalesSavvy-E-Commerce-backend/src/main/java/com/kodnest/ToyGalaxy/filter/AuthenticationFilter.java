package com.kodnest.ToyGalaxy.filter;

import com.kodnest.ToyGalaxy.Enum.Role;
import com.kodnest.ToyGalaxy.Repo.UserRepository;
import com.kodnest.ToyGalaxy.Service.AuthService;
...
public class AuthenticationFilter implements Filter {
    ...
    private void executeFilterLogic(ServletRequest request, ServletResponse response, FilterChain chain)
        ...
        logger.error("Authenticated User: {}, Role: {}", authenticatedUser.getUsername(), role);
